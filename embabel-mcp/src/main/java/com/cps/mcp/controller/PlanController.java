...
public class PlanController {
    ...
    public Map<String, Object> plan(@RequestBody Map<String, Object> body) {
        // Clear the shared singleton blackboard to prevent state pollution from
        // previous requests
        try {
            blackboard.clear();
                    ...
                    private boolean isActionCaller() {
                        ...
                        for (StackTraceElement element : stack) {
                            ...
                            if (className.contains("com.cps.mcp.agent") ||
                                ...
                                methodName.contains("executeAction") ||
                                methodName.contains("ActionMethod")) {
                                return true;
                            }
                        }
                        return false;
                    ...
                    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                        ...
                        if (args != null && args.length > 0) {
                            ...
                            if ("getObjects".equals(methodName)) {
                                ...
                                modifiedObjects.add(new UserInput(act ? goalStr : mappedGoalStr));
    ...
    private Map<String, Object> executeEmbabelPlanner(String goalStr, com.cps.mcp.agent.TravelIntent intent)
            throws Exception {
        // Map the TravelIntent to the correct terminal goal string
        String mappedGoalStr = mapIntentToGoal(intent);

        // Instantiate a fresh InMemoryBlackboard to prevent state pollution across
        // requests
        ...
        // Restored compliance with stable 8-field response contract (no
        // classifiedIntent)
